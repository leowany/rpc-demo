package com.leo.rpc.registry.zk.util;

import com.leo.rpc.enums.RpcConfigEnum;
import com.leo.rpc.utils.PropertiesFileUtil;
...
public final class CuratorUtils {
	...
	public static void createPersistentNode(CuratorFramework zkClient, String path) {
		try {
			if (REGISTERED_PATH_SET.contains(path) || zkClient.checkExists().forPath(path) != null) {
				...
				// eg: /my-rpc/com.leo.rpc.HelloService/127.0.0.1:9999
	 ...
	 *                       eg:com.leo.rpc.HelloServicetest2version1
	 ...
	 *
	 * @param rpcServiceName rpc service name
	 *                       eg:com.leo.rpc.HelloServicetest2version
	 */
